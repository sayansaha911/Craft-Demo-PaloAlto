...
helm upgrade demo-app ./helm-chart/ --set image.repository=${app_name} --set image.tag=${app_version}
else

echo "Installing web-app"
helm install demo-app ./helm-chart/ --set image.repository=${app_name} --set image.tag=${app_version}
fi
